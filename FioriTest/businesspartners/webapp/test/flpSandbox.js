		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#stbusinesspartners-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"stbusinesspartners-display": {
								"semanticObject": "stbusinesspartners",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=st.businesspartners",
									"url": sap.ui.require.toUrl("st/businesspartners")
								}
							}
						}
					}
